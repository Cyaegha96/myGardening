...
export default function DomeGallery({
  ...
  const unlockScroll = useCallback(() => {
    ...
    const items = useMemo(() => buildItems(galleryImages, segments), [galleryImages, segments]);
          ...
          <div className="stage">
            <div ref={sphereRef} className="sphere">
              {items.map((it, i) => (
                ...
                >
                  <div
                    className="item__image absolute block overflow-hidden cursor-pointer bg-accent transition-transform duration-300"
                    role="button"
                    tabIndex={0}
